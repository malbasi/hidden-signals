...
module.exports = "/age_gap.1f6e3fc3.csv";
...
function ready(datapoints) {
  // Add dots for each
  svg.selectAll('circles').data(datapoints).enter().append('circle').attr('r', 3).attr('cx', function (d) {
  ...
  svg.append('line').attr('x1', 0).attr('y1', height).attr('x2', width).attr('y2', 0).attr('stroke', 'red').attr('stroke-width', 2).attr('opacity', 0.5).lower();

  // add text. This is garbage atm, but i forget how translate rotate works
  svg.append('text').text('Actors are the same age').attr('x', 350).attr('y', 450).attr('text-anchor', 'middle').attr('transform', 'rotate(-45)');
...
//# sourceMappingURL=/02-chart.3a171d14.map