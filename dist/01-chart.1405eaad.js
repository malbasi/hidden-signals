...
module.exports = "/Philadelphia.59141c88.topojson";
},{}],"data/philly-homicides-2012-present.csv":[function(require,module,exports) {
module.exports = "/philly-homicides-2012-present.12331668.csv";
...
function ready(_ref) {
  ...
  d3.select('#murders-2012').on('stepin', function () {
    svg.selectAll('.year1').data(nested).enter().append('circle').attr('class', 'year1').attr('r', 10).attr('cx', 1).attr('cy', 1).attr('transform', function (d) {
...
//# sourceMappingURL=/01-chart.1405eaad.map