...
exports.default = _default;
},{"d3":"../node_modules/d3/index.js"}],"data/same-age.csv":[function(require,module,exports) {
module.exports = "/same-age.3260cf34.csv";
...
var svg = d3.select('#images').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
svg.append('rect').attr('width', width).attr('height', height).attr('opacity', 0);

var xPositionScale = _fisheye.default.scale(d3.scaleLinear).range([0, width]).focus(width / 2).distortion(5); // var colorScale = d3.scaleOrdinal(d3.schemeCategory10)


d3.csv(require('./data/same-age.csv')).then(ready).catch(function (err) {
...
function ready(datapoints) {
  ...
  }).attr('width', 190).attr('height', height).on('mouseover', function (d) {
    console.log(d);
    var str = d['Movie Name'].replace(/'/g, '');
    var class_selected = str.replace(/\s+/g, '-').toLowerCase(); // console.log(str)
...
},{"d3":"../node_modules/d3/index.js","./fisheye":"fisheye.js","d3-scale":"../node_modules/d3-scale/src/index.js","./data/same-age.csv":"data/same-age.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","images.js"], null)
//# sourceMappingURL=/images.d9243ab0.map