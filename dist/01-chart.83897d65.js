...
d3.csv(require('./data/top_directors.csv')).then(ready).catch(function (err) {
  return console.log('Failed on', err);
});

function ready(datapoints) {
  // set ypositionscale domain
  var movieName = datapoints.map(function (d) {
    return d['Actor 2 Name'];
  });
  ...
  svg.selectAll('act1').data(datapoints).enter().append('circle').attr('class', 'act1').attr('cx', function (d) {
  ...
  svg.selectAll('act2').data(datapoints).enter().append('circle').attr('class', 'act2').attr('cx', function (d) {
  ...
  svg.selectAll('bar').data(datapoints).enter().append('line').attr('class', 'bar').attr('x1', function (d) {
  ...
  svg.append('line').attr('x1', 50).attr('y1', 0).attr('x2', 50).attr('y2', height).attr('stroke-dasharray', '3,5').attr('stroke-width', 2).attr('stroke', 'red').attr('opacity', 0.5).lower();
...
},{"d3":"../node_modules/d3/index.js","./data/top_directors.csv":"data/top_directors.csv"}],"../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/01-chart.83897d65.map