...
module.exports = "/top_directors_withimg2.ea3e4c90.csv";
...
var colorScale = d3.scaleOrdinal().range(['#BC5E21', '#749CA8', '#DBA946', '#726738', '#B38971', '#fdb462', '#b3de69']);

var xPositionScale = d3.scaleLinear().range([0, width]).domain([15, 70]);

var yPositionScale = d3.scalePoint().range([height, 120]);
...
function ready(datapoints) {
  ...
  var directorName = datapoints.map(function (d) {
    return d['Director'];
  });
  ...
  // add label circles
  var labels = svg.append('g').attr('transform', 'translate(10, 0)');

  labels.selectAll('.label-circle').data(nested).enter().append('g').attr('transform', function (d, i) {
    return 'translate(' + i * 120 + ', 0)';
  }).each(function (d) {
    var g = d3.select(this);
    g.append('circle').attr('r', 40).attr('cx', 20).attr('cy', 20).attr('fill', function (d) {
      return 'url(#' + d.key.toLowerCase().replace(/ /g, '') + ')';
    }).attr('class', function (d) {
      return d.key.toLowerCase().replace(' ', '');
    }).classed('labels', true).attr('opacity', '0.2');
  });

  labels.selectAll('.label-text').data(nested).enter().append('g').attr('transform', function (d, i) {
    return 'translate(' + i * 110 + ', 50)';
  }).each(function (d) {
    var g = d3.select(this);
    g.append('text').attr('x', 0).attr('dx', function (d) {
    ...
    }).attr('y', 30).attr('fill', colorScale(d.key)).attr('class', function (d) {
      return 'text' + d.key.toLowerCase().replace(' ', '');
    }).classed('labels-text', true).text(d.key).attr('font-size', 12).attr('font-weight', 'bold').attr('text-alignment', 'middle').attr('opacity', 0.2);
  });

  // draw the average line and hide it
  // place line for 18 y.o.
  svg.append('line').attr('x1', 50).attr('y1', 100).attr('x2', 50).attr('y2', height).attr('stroke-dasharray', '3,5').attr('stroke-width', 2).attr('stroke', 'red').attr('class', 'average-line').attr('opacity', 0.5).lower().style('visibility', 'hidden');
  ...
  svg.selectAll('act1').data(dir1Datapoints).enter().append('circle').attr('class', 'act1').transition().attr('cx', function (d) {
  ...
  svg.selectAll('act2').data(dir1Datapoints).enter().append('circle').attr('class', 'act2').transition().attr('cx', function (d) {
  ...
  svg.selectAll('bar').data(dir1Datapoints).enter().append('line').transition().attr('class', 'bar').attr('x1', function (d) {
    ...
    return colorScale(d.Director);
  }).attr('opacity', 0.5).style('visibility', 'hidden');

  // Scrollytelling!
  // for each director, update the y-axis and redraw the barbells
  d3.select('#top3').on('stepin', function () {
    var dir1MovieName = dir1Datapoints.map(function (d) {
      return d['Movie Name'];
    });
    yPositionScale.domain(dir1MovieName);
    ...
    svg.selectAll('.woodyallen').transition().attr('opacity', 0.2);

    svg.selectAll('.labels-text').transition().attr('opacity', 0.2).attr('fill', function (d) {
      return colorScale(d.key);
    });
    svg.selectAll('.textwoodyallen').transition().attr('opacity', 0.2);
    ...
    svg.append('g').transition().attr('class', 'axis y-axis').call(yAxis).style('visibility', 'hidden');
  ...
  d3.select('#director1').on('stepin', function () {
    ...
    svg.selectAll('act2').data(dir1Datapoints).enter().append('circle').transition().attr('class', 'act2').attr('cx', function (d) {
      var age = +d['Actor 2 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
  ...
  d3.select('#director2').on('stepin', function () {
    ...
    svg.selectAll('act1').data(dir2Datapoints).enter().append('circle').attr('class', 'act1').transition().attr('cx', function (d) {
      var age = +d['Actor 1 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('act2').data(dir2Datapoints).enter().append('circle').attr('class', 'act2').transition().attr('cx', function (d) {
      var age = +d['Actor 2 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('bar').data(dir2Datapoints).enter().append('line').transition().attr('class', 'bar').attr('x1', function (d) {
      return xPositionScale(+d['Actor 1 Age']);
    }).attr('y1', function (d) {
      return yPositionScale(d['Movie Name']);
    }).attr('x2', function (d) {
  ...
  d3.select('#director3').on('stepin', function () {
    ...
    svg.selectAll('act1').data(dir3Datapoints).enter().append('circle').attr('class', 'act1').transition().attr('cx', function (d) {
      var age = +d['Actor 1 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('act2').data(dir3Datapoints).enter().append('circle').attr('class', 'act2').transition().attr('cx', function (d) {
      var age = +d['Actor 2 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('bar').data(dir3Datapoints).enter().append('line').attr('class', 'bar').transition().attr('x1', function (d) {
      return xPositionScale(+d['Actor 1 Age']);
    }).attr('y1', function (d) {
      return yPositionScale(d['Movie Name']);
    }).attr('x2', function (d) {
  ...
  d3.select('#director4').on('stepin', function () {
    ...
    svg.selectAll('act1').data(dir4Datapoints).enter().append('circle').attr('class', 'act1').transition().attr('cx', function (d) {
      var age = +d['Actor 1 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('act2').data(dir4Datapoints).enter().append('circle').attr('class', 'act2').transition().attr('cx', function (d) {
      var age = +d['Actor 2 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('bar').data(dir4Datapoints).enter().append('line').attr('class', 'bar').transition().attr('x1', function (d) {
      return xPositionScale(+d['Actor 1 Age']);
    }).attr('y1', function (d) {
      return yPositionScale(d['Movie Name']);
    }).attr('x2', function (d) {
  ...
  d3.select('#director5').on('stepin', function () {
    ...
    svg.selectAll('act1').data(dir5Datapoints).enter().append('circle').attr('class', 'act1').transition().attr('cx', function (d) {
      var age = +d['Actor 1 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('act2').data(dir5Datapoints).enter().append('circle').attr('class', 'act2').transition().attr('cx', function (d) {
      var age = +d['Actor 2 Age'];
      return xPositionScale(age);
    }).attr('cy', function (d) {
      return yPositionScale(d['Movie Name']);
    ...
    svg.selectAll('bar').data(dir5Datapoints).enter().append('line').attr('class', 'bar').transition().attr('x1', function (d) {
      return xPositionScale(+d['Actor 1 Age']);
    }).attr('y1', function (d) {
      return yPositionScale(d['Movie Name']);
    }).attr('x2', function (d) {
...
},{"d3":"../node_modules/d3/index.js","./data/top_directors_withimg2.csv":"data/top_directors_withimg2.csv"}],"../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/01-chart.444c66e5.map