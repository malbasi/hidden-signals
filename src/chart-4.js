...
function ready (datapoints) {
  ...
  d3.select('svg').append('image')
    .attr('xlink:href', 'https://raw.githubusercontent.com/malbasi/hidden-signals/master/src/images/cellphone.png')
  ...
  // add antenna
  d3.select('svg').append('image')
    .attr('xlink:href', 'https://raw.githubusercontent.com/malbasi/hidden-signals/master/src/images/antenna.png')
    .attr('class', 'antenna')
    .attr('x', width / 2 * 1.2)
    .attr('y', 0)
    .attr('width', 80)
  ...
  // add person
  d3.select('svg').append('image')
    .attr('xlink:href', 'https://raw.githubusercontent.com/malbasi/hidden-signals/master/src/images/person.png')
    .attr('class', 'person')
    .attr('x', 60)
    .attr('y', startY)
    .attr('width', 80)
  ...
  d3.select('svg').append('image')
    .attr('class', 'mitm')
    .attr('xlink:href', 'https://raw.githubusercontent.com/malbasi/hidden-signals/master/src/images/mitm.png')
    .attr('x', width * 0.8)
